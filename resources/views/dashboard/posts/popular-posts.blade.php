...
@section('title', 'NEWSROOM - POPULAR POSTS')
@section('content')
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="row">
                    ...
                    @foreach ($latestBigPosts as $post)
                    <div class="col-lg-6">
                        <div class="position-relative mb-3">
                            <img class="img-fluid w-100" src="{{$post->default_image}}" style="object-fit: cover; height: 250px;">
                ...
                <div class="row">
                    @foreach($latestSmallPosts as $post)
                    <div class="col-lg-6">
